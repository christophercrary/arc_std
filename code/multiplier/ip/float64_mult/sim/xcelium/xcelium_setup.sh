...
# ACDS 19.2 57 linux 2022.09.26.21:03:04
...
# ----------------------------------------
# If float64_mult is one of several IP cores in your
...
TOP_LEVEL_NAME="float64_mult.float64_mult"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/tools/Intel/quartus_pro/19.2.0.57/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [float64_mult::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [float64_mult::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [float64_mult::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [float64_mult::get_design_libraries]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [float64_mult::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [float64_mult::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [float64_mult::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
